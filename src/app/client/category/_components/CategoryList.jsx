...
import { _categoryDeleteAction, _categoryListAction, _categorySearchAction } from '@/actions/CategoryActions';
...
export default function CategoryList({ dbData }) {
    const {categoryState, categoryDispatch } = AdminContextState()
